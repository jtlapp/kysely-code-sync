...
The `load-kysely-tests` command requires quite a bit of setup. I found it easiest to locally mirror the Kysely test structure and borrow `package.json` test scripts from Kysely. Here is the structure I have working with [`kysely-pg-client`](https://github.com/jtlapp/kysely-pg-client):
